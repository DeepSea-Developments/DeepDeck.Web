...
- `npm run compress-artifacts` to compress the components
...
A desktop version is being developed using electron. change to the branch feature/electron to have the version
